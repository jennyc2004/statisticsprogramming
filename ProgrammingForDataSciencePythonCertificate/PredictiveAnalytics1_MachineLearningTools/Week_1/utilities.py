...
import pydotplus
from sklearn.metrics import classification_report, classification, regression, recall_score
from sklearn.tree import export_graphviz
import numpy as np
import math


def plotDecisionTree(decisionTree, feature_names=None, class_names=None, impurity=True):
